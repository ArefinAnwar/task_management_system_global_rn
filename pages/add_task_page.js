...
export default function add_task_page({ navigation }) {
                ...
                <View style={{ width: '100%', marginTop: 30, alignItems: 'center', justifyContent: 'center' }}>
                    <View style={styles.add_task_con}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', }}>
                            ...
                            <View style={styles.task_heading_con}>
                                <View style={{ marginLeft: 25 }}>
                                    ...
                                    <TextInput style={styles.task_heading_input}  onChangeText={(text) => set_task_heading(text)}></TextInput>
                                </View>
                            ...
                            <View style={styles.task_deadline_con}>
                                <View>
                                    ...
                                    <TextInput style={styles.task_deadline_input} onChangeText={(text) => set_task_deadline(text)}></TextInput>
                                </View>
                            </View>
                        ...
                        <View style={styles.task_body_con}>
                            <View style={{}}>
                                ...
                                <TextInput style={styles.task_body_input} multiline={true} onChangeText={(text) => set_task_body(text)}></TextInput>
                            </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', alignSelf: 'stretch' }}>
                        <View style={{marginLeft: 900, marginTop: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                            ...
                            <TouchableOpacity style={{marginLeft: 30 ,flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}><Image source={cross} style={{ width: 28, height: 28 }} /><Text style={{ color: '#F83C3C', fontSize: 18 }}>Cancel</Text></TouchableOpacity>
                        </View>
                    </View>
                </View>
